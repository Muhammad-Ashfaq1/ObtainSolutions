<?php $__env->startSection('title', 'ObtainSolutions - Software House & Digital Agency | Web, App, API & SaaS Development'); ?>
<?php $__env->startSection('meta_description', 'ObtainSolutions is a software house and digital agency specializing in custom web apps, mobile apps, APIs, and SaaS platforms. We help startups and businesses design, build, and scale digital products with PHP, Laravel, and modern frontends.'); ?>
<?php $__env->startSection('meta_keywords', 'software house, digital agency, web development agency, custom software development, laravel development company, mobile app agency, saas development company, api development services, offshore development team, product engineering, ui ux agency, pakistan software house'); ?>
...
<nav class="navbar navbar-expand-lg landing-navbar sticky-top py-3">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-3" href="#home">
            <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="ObtainSolutions logo" width="44" height="44" style="border-radius: 0.75rem;">
            <span>
        ...
        <div class="container">
            ...
            <div class="industry-strip">
                <div class="industry-track">
                    <?php $__currentLoopData = [0, 1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $copy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $stack; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="industry-chip" <?php if($copy === 1): ?> aria-hidden="true" <?php endif; ?>>
                                <i class="ti <?php echo e($tech['icon']); ?>"></i>
                                <?php echo e($tech['label']); ?>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-reveal="left">
                    <img src="<?php echo e(asset('assets/img/saas-services.png')); ?>" alt="ObtainSolutions software house team" class="img-fluid rounded-4">
                </div>
                ...
                <div class="industry-track">
                    <?php $__currentLoopData = [0, 1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $copy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="industry-chip" <?php if($copy === 1): ?> aria-hidden="true" <?php endif; ?>>
                                <i class="ti <?php echo e($client['icon']); ?>"></i>
                                <?php echo e($client['label']); ?>
                    ...
                    <div class="services-grid">
                        <?php $__currentLoopData = [
                            ...
                            <div class="service-pill">
                                ...
                                <span class="fw-medium"><?php echo e($service); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <div class="row g-3">
                <?php $__currentLoopData = [
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="landing-card">
                            <span class="landing-icon mb-3"><i class="ti <?php echo e($item['icon']); ?>"></i></span>
                            <h5 class="mb-2"><?php echo e($item['title']); ?></h5>
                            <p class="text-muted mb-0"><?php echo e($item['text']); ?></p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5" data-reveal="left">
                    ...
                    <img src="<?php echo e(asset('assets/img/web-development.jpg')); ?>" alt="ObtainSolutions development process" class="img-fluid rounded-4">
                </div>
                            ...
                            <?php $__currentLoopData = [
                                ...
                                <div class="col-12">
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="fw-medium"><?php echo e($benefit); ?></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="accordion" id="faqAccordion">
                            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="faq-heading-<?php echo e($index); ?>">
                                        <button class="accordion-button <?php echo e($index !== 0 ? 'collapsed' : ''); ?>" type="button" data-bs-toggle="collapse" data-bs-target="#faq-collapse-<?php echo e($index); ?>" aria-expanded="<?php echo e($index === 0 ? 'true' : 'false'); ?>" aria-controls="faq-collapse-<?php echo e($index); ?>">
                                            <?php echo e($faq['q']); ?>

                                        </button>
                                    </h2>
                                    <div id="faq-collapse-<?php echo e($index); ?>" class="accordion-collapse collapse <?php echo e($index === 0 ? 'show' : ''); ?>" aria-labelledby="faq-heading-<?php echo e($index); ?>" data-bs-parent="#faqAccordion">
...
<footer class="footer-shell pt-5 pb-4">
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="ObtainSolutions logo" width="40" height="40" style="border-radius: 0.7rem;">
                    <div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between gap-2">
            <p class="mb-0">&copy; <?php echo e(now()->year); ?> ObtainSolutions. All rights reserved.</p>
...
?>
<?php $__currentLoopData = $structuredData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schema): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbookpro2019/Projects/ObtainSolutions/resources/views/welcome.blade.php ENDPATH**/ ?>